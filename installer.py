...
def run_installation(ui):
    ...
    # try:
    #     copy_icons(icons, icons_light_dir, icons_dark_dir)
    #     copy_scripts(scripts, install_dir)
    #     copy_scripts(macros, max_user_macros_dir)
    #     # ui.progress_bar.add()
    # except (IOError, os.error) as e:
    #     ui.error_msg(e)
    #     return
...
class RenderFarmingInstaller(QtW.QDialog):

    def __init__(self, parent=None):
        super(RenderFarmingInstaller, self).__init__(parent)
